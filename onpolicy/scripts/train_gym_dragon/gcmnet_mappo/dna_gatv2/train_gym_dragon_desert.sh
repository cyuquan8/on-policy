...
exp="region_${region}_lr_${lr}_critic_lr_${critic_lr}_ppo_epoch_${ppo_epoch}_clip_param_${clip_param}_gnn_arch_${gcmnet_gnn_architecture}_n_gnn_layers_${n_gnn_layers}_rni_ratio_${rni_ratio}_cpa_model_${gcmnet_cpa_model}"
