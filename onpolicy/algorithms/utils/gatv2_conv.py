...
class GATv2Conv(MessagePassing):
    ...
    def edge_update(self, x_j: Tensor, x_i: Tensor, edge_attr: OptTensor,
        ...
        # add source and target embeddings to 'emulate' concatentation given 
        # that linear layer is applied already
    ...
    def message(self, x_j: Tensor, alpha: Tensor) -> Tensor:
        # (num_edges, att_heads, out_channels) * (num_edges, att_heads, 1) -->
        # (num_edges, att_heads, out_channels)
