...
class MAGICRunner(object):
    """
    Base class for training MAGIC policies.
    ...
    def __init__(self, config):
        ...
        from onpolicy.algorithms.magic_mappo.magic_mappo import MAGIC_MAPPO as TrainAlgo
        from onpolicy.algorithms.magic_mappo.algorithm.magicMAPPOPolicy import MAGIC_MAPPOPolicy as Policy
        from onpolicy.utils.shared_magic_buffer import SharedMAGICReplayBuffer as SharedReplayBuffer
