...
class SharedG2ANetReplayBuffer(object):
    """
    ...
    def insert(self, share_obs, obs, lstm_hidden_states_actor, lstm_cell_states_actor, lstm_hidden_states_critic, 
               lstm_cell_states_critic, actions, action_log_probs, value_preds, rewards, masks, bad_masks=None, 
    ...
    def chooseinsert(self, share_obs, obs, lstm_hidden_states_actor, lstm_cell_states_actor, lstm_hidden_states_critic, 
                     lstm_cell_states_critic, actions, action_log_probs, value_preds, rewards, masks, bad_masks=None, 
                     active_masks=None, available_actions=None):
        """
    ...
    def feed_forward_generator(self, advantages, num_mini_batch=None, mini_batch_size=None):
        ...
        """
        raise NotImplementedError("feed_forward_generator not implemented for G2ANet")
    ...
    def naive_recurrent_generator(self, advantages, num_mini_batch):
        ...
        :param num_mini_batch: (int) number of minibatches to split the batch into.
        """
        raise NotImplementedError("naive_recurrent_generator not implemented for G2ANet")
    ...
    def recurrent_generator(self, advantages, num_mini_batch, data_chunk_length):
        ...
        lstm_hidden_states_actor = _cast(self.lstm_hidden_states_actor[:-1])
        lstm_cell_states_actor = _cast(self.lstm_cell_states_actor[:-1])
        lstm_hidden_states_critic = _cast(self.lstm_hidden_states_critic[:-1])
        lstm_cell_states_critic = _cast(self.lstm_cell_states_critic[:-1])
        ...
        for indices in sampler:
            ...
            yield share_obs_batch, obs_batch, lstm_hidden_states_actor_batch, lstm_cell_states_actor_batch,\
                  lstm_hidden_states_critic_batch, lstm_cell_states_critic_batch, actions_batch, value_preds_batch,\
