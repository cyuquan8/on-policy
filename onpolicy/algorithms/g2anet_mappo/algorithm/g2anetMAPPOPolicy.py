import torch
from onpolicy.algorithms.g2anet_mappo.algorithm.g2anet_actor_critic import G2ANet_Actor, G2ANet_Critic
from onpolicy.utils.util import update_linear_schedule


class G2ANet_MAPPOPolicy:
    """
    G2ANet MAPPO Policy class. Wraps actor and critic networks to compute actions and value function predictions.
    ...
    def __init__(self, args, obs_space, cent_obs_space, act_space, device=torch.device("cpu")):
        ...
        self.actor = G2ANet_Actor(args, self.obs_space, self.act_space, self.device)
        self.critic = G2ANet_Critic(args, self.share_obs_space, self.device)
