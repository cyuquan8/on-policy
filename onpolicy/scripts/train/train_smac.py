...
def main(args):
    ...
    if all_args.algorithm_name == "rmappo":
        ...
        print("u are choosing to use gcmnet_dna_gatv2_mappo, we set use_centralized_V to be True")
        all_args.use_centralized_V = True
    elif all_args.algorithm_name == "gcmnet_gin_mappo":
        print("u are choosing to use gcmnet_gin_mappo, we set use_centralized_V to be True")
        all_args.use_centralized_V = True
    else:
        raise NotImplementedError
