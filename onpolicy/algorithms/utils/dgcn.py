...
class DGCN_Linear(torch.nn.Module):
...
class MultiHead(Attention):
    ...
    def __init__(self, in_channels, out_channels, heads = 1, groups = 1, dropout = 0, bias = True):
        ...
        self.lin_q = DGCN_Linear(in_channels, out_channels, groups, bias)
        self.lin_k = DGCN_Linear(in_channels, out_channels, groups, bias)
        self.lin_v = DGCN_Linear(in_channels, out_channels, groups, bias)
